        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h2 class="ipt-title">Who We Are?</h2>
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="icon-mi-left">
                        ...
                        <div class="icon-mi-left-content">
                            <h4>We are Saving and Creating Jobs</h4>
                            <p>Based in Rwanda, Next Deals is an online market platform on a mission of creating jobs for
                                youths and other talented and skilled people with no platform. Our mission is empowering
                                micro businesses and individuals with talent and skills to use them and create jobs for
                    ...
                    <div class="icon-mi-left">
                        ...
                        <div class="icon-mi-left-content">
                            <h4>A platform for trusted sellers to create jobs</h4>
                            <p>We onboard the best creators with talent and skills and offer them a platform to sell their
                                items through our online platform or our exhibition shop.</p>
                        </div>
                    </div>
